...
//       <div className="w-[22%] flex flex-col gap-3.75">
//         <a href="#home" className="text-[#F8F6F1] hover:opacity-80 transition-opacity duration-300">
...
//         <a href="#menu"        className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Menu</a>
//         <a href="#reservation" className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Reservations</a>
//         <a href="#experiences" className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Experiences</a>
//         <a href="#story"       className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Our Story</a>
//       </div>

//       <div className="w-[22%] flex flex-col gap-3.75">
//         <p className="text-[12px] uppercase text-[#C09D59] tracking-[4.8px] font-normal font-inter">Experience</p>
//         <a href="#private"  className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Private Dining</a>
//         <a href="#chef"     className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Chef's Table</a>
//         <a href="#events"   className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Events</a>
//         <a href="#delivery" className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Delivery</a>
//         <a href="#gifts"    className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-white transition-all duration-200 font-inter">Gift Cards</a>
//       </div>
...
//         <a href="#privacy" className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-[white] transition-all duration-200 font-inter">Privacy</a>
//         <a href="#terms"   className="text-[14px] font-normal leading-5 text-[#988C81] hover:text-[white] transition-all duration-200 font-inter">Terms</a>
//       </div>
//     </div>
