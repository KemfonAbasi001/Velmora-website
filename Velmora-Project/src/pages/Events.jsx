...
// import bg_image from '../assets/table_one.png'
...
//     icon: (
//       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-[#C09D59]">
...
//   return (
//     <div className="flex flex-col gap-3 p-10 border border-[rgba(50,46,42,0.3)] hover:border-[#735E35] transition-all duration-300">
//       {props.icon}
...
//       <section style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.6)), url(${bg_image})` }} className="w-full bg-cover bg-center bg-no-repeat pt-65 pb-12.5 pr-0 pl-12.5">
//         <div className="flex flex-col gap-3.75">
//             <p className="text-[12px] leading-4 font-normal tracking-[4.8px] text-[#C09D59] uppercase font-inter">Private Events</p>
//             <h1 className="text-[72px] leading-18 font-light text-[#F8F6F1] font-cormorant">Bespoke <span className="italic">Gatherings</span></h1>
//         </div>
//       </section>
...
//         <p className="text-xs uppercase tracking-[4.8px] text-[#C09D59] font-inter">
//           Occasions
//         </p>
//         <h1 className="text-[48px] font-light leading-12 text-[#F8F6F1] font-cormorant">
...
//       {/* Cards Grid */}
//       <div className="w-[90%] grid grid-cols-3 gap-7.5">
//         {eventCards.map((card) => (
//           <EventCard
//             key={card.title}
//             icon={card.icon}
...
//           Private Events
//         </p>
//         <h1 className="text-[36px] font-light leading-10 text-[#F8F6F1] font-cormorant">
//           Plan Your Event
//         </h1>
//         {/* Decorator */}
//         <div className="flex items-center gap-3.75">
...
//           <div className="w-11.75 h-px bg-linear-to-l from-[#0A0A0A] to-[#735E35]" />
//         </div>
//         <p className="text-[16px] leading-6 text-[#988C81] max-w-125 font-inter">
...
function EventCard(props) {
  return (
    <div data-reveal data-delay={props.delay} className="flex flex-col gap-3 p-10 border border-[rgba(50,46,42,0.3)] hover:border-[#735E35] transition-all duration-300">
      {props.icon}
      <h3 className="text-xl font-normal text-[#F8F6F1] font-cormorant">
        {props.title}
      </h3>
  ...
  return (
    <>
      ...
      <section style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.6)), url(${bg_image})` }} className="w-full bg-cover bg-center bg-no-repeat pt-65 pb-12.5 pr-0 pl-12.5">
        <div className="flex flex-col gap-3.75">
            ...
            <h1 data-reveal data-delay="80" className="text-[72px] leading-18 font-light text-[#F8F6F1] font-cormorant">Bespoke <span className="italic">Gatherings</span></h1>
        </div>
      </section>
      ...
      <div className="w-[90%] flex flex-col items-center gap-5 text-center">
        ...
        <h1 data-reveal data-delay="80" className="text-[48px] font-light leading-12 text-[#F8F6F1] font-cormorant">
          Every Moment <span className="italic">Elevated</span>
        </h1>
        {/* Decorator */}
    ...
    <section className="w-full py-37.5 bg-[rgb(22,20,19)] flex flex-col items-center justify-center gap-12.5">
      ...
      <div className="w-[90%] flex flex-col items-center gap-5 text-center">
        ...
        <h1 data-reveal data-delay="80" className="text-[36px] font-light leading-10 text-[#F8F6F1] font-cormorant">
          Plan Your Event
        </h1>
        {/* Decorator */}
        <div data-reveal data-delay="160" className="flex items-center gap-3.75">
        ...
        <p data-reveal data-delay="240" className="text-[16px] leading-6 text-[#988C81] max-w-125 font-inter">
          Share your vision and our team will curate every detail.
        </p>
      </div>

      {/* Form */}
      <div data-reveal data-delay="320" className="w-[40%]">
        <form className="flex flex-col gap-7.5" onSubmit={handleSubmit}>
