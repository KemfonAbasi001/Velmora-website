...
//       {/* Text block */}
//       <div className="w-full md:w-[50%] flex flex-col gap-3 md:gap-5 p-6 sm:p-10 md:p-15 bg-[#2c28264d] justify-center">
//         <p className="leading-4 font-normal uppercase font-inter tracking-[4.8px] text-[11px] md:text-[12px] text-[#c09d59]">
//           {props.smalltext}
//         </p>
...
//         <p className="leading-7 font-normal font-inter text-[14.4px] md:text-[16px] text-[#988c81]">
//           {props.midtext}
//         </p>

//         <p className="tracking-[2.4px] flex items-center uppercase mt-2 text-[#C09D59] w-fit gap-2.5 transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:text-[#e8b978] text-[12px] md:text-[13px]">
//           {props.paragraphtext}
//           <svg
...
//       <section className="w-full bg-[#0A0A0A] flex flex-col items-center gap-12 md:gap-20 py-40 md:py-50">
...
//         {/* === CARDS === */}
//         <div className="w-[90%] flex flex-col gap-15 md:gap-25">
//           <CardExp
//             picone={table_three1}
//             smalltext="Cocktail Atelier"
//             bigtext="The Bar"
...
//     >
//       {/* Image — full width on mobile, half on desktop */}
//       <div className="w-[100%] h-65 md:h-auto overflow-hidden">
//         <img
//           src={props.picone}
//           alt={props.bigtext}
//           className="w-full h-full object-cover block"
...
function CardExp(props) {
  return (
    <div
      ...
      id="experience-card"
    >
      {/* Image — full width on mobile/tablet, half on desktop */}
      <div className="w-full lg:w-[50%] h-65 lg:h-auto overflow-hidden">
        <img
          src={props.picone}
          alt={props.bigtext}
          className="w-full h-full object-cover block"
      ...
      <div className="w-full lg:w-[50%] flex flex-col gap-3 lg:gap-5 p-6 sm:p-10 lg:p-15 bg-[#2c28264d] justify-center">
        ...
        <p className="leading-7 font-normal font-inter text-[14.4px] lg:text-[16px] text-[#988c81]">
          {props.midtext}
        </p>

        <p className="tracking-[2.4px] flex items-center uppercase mt-2 text-[#C09D59] w-fit gap-2.5 transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:text-[#e8b978] text-[12px] lg:text-[13px]">
          {props.paragraphtext}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
function Experience() {
  return (
    <>
      ...
      <section className="w-full bg-[#0A0A0A] flex flex-col items-center gap-12 lg:gap-20 py-40 lg:py-50">
        ...
        {/* === CARDS === */}
        <div className="w-[90%] flex flex-col gap-15 lg:gap-25">
          <CardExp
            picone={table_three1}
            smalltext="Cocktail Atelier"
            bigtext="The Bar"
